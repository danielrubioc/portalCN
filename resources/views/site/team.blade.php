...
@section('content')
	...
	<div class="info-content-detail content-team-description">
         ...
         <span class="hidden-xs">
            <div class="container margin-team">
                <div class="workshop-all">
                    ...
                    <div class="info-taller desktop-taller-team">
                        
                            <div id="team-modify-container">
                                <div class="col-xs-3">
                                    <div class="item-work item-team">
                                        <img src="{{url('/images/team-desktop')}}/claudio-varela.jpg" class="img-responsive">
                            ...
                            <div id="team-modify-container">
                                <div class="col-xs-3">
                                    <div class="item-work item-team">
                                        <img src="{{url('/images/team-desktop')}}/mario-baeza.jpg" class="img-responsive">
                                        <span class="info-team desktop-info">
                                            <h1>Mario Baeza</h1>
                            ...
                            <div id="team-modify-container">
                                <div class="col-xs-3">
                                    <div class="item-work item-team">
                                        <img src="{{url('/images/team-desktop')}}/myriam-curiarte.jpg" class="img-responsive">
                                        <span class="info-team desktop-info">
                            ...
                            <div id="team-modify-container">
                                <div class="col-xs-3">
                                    <div class="item-work item-team">
                                        <img src="{{url('/images/team-desktop')}}/ignacio-martinez.jpg" class="img-responsive">
                                        <span class="info-team desktop-info">
                            ...
                            <div id="team-modify-container">
                                <div class="col-xs-3">
                                    <div class="item-work item-team">
                                        <img src="{{url('/images/team-desktop')}}/cristina-beltran.jpg" class="img-responsive">
                                        <span class="info-team desktop-info">
                            ...
                            <div id="team-modify-container">
                                <div class="col-xs-3">
                                    <div class="item-work item-team">
                                        <img src="{{url('/images/team-desktop')}}/pedro-lopez.jpg" class="img-responsive">
                                        <span class="info-team desktop-info">
                                            <h1>Pedro López</h1>
                            ...
                            <div id="team-modify-container">
                                <div class="col-xs-3">
                                    <div class="item-work item-team">
                                        <img src="{{url('/images/team-desktop')}}/jeaqueline-burgos.jpg" class="img-responsive">
                                        <span class="info-team desktop-info">
